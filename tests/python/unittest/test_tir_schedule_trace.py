...
if __name__ == "__main__":
    ...
    test_trace_construct_get_decision_1()
    test_trace_construct_append_1()
    test_trace_construct_pop_1()
    test_trace_construct_pop_2()
    test_trace_apply_to_schedule()
    test_trace_as_json_1()
    test_trace_simplified_1()
    test_trace_simplified_2()
    test_apply_json_to_schedule_1()
