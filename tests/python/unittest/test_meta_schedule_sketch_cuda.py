...
def test_meta_schedule_cuda_sketch_matmul_relu():
    ...
    expected = [
        [
            ...
            "l45, l46 = sch.split(loop=l42, factors=[v43, v44])",
            "sch.vectorize(loop=l46)",
            'sch.annotate(block_or_loop=l45, ann_key="meta_schedule.lazy_cooperative_fetch", ann_val=1)',
            'b47 = sch.cache_read(block=b0, read_buffer_index=2, storage_scope="shared")',
            "sch.compute_at(block=b47, loop=l29, preserve_unit_loops=1)",
            "l48, l49, l50, l51, l52, l53 = sch.get_loops(block=b47)",
            "l54 = sch.fuse(l52, l53)",
            "v55, v56 = sch.sample_perfect_tile(loop=l54, n=2, max_innermost_factor=4)",
            "l57, l58 = sch.split(loop=l54, factors=[v55, v56])",
            "sch.vectorize(loop=l58)",
            'sch.annotate(block_or_loop=l57, ann_key="meta_schedule.lazy_cooperative_fetch", ann_val=1)',
...
def test_meta_schedule_cuda_sketch_conv2d_nchw():
    ...
    expected = [
        [
            ...
            "l85, l86 = sch.split(loop=l82, factors=[v83, v84])",
            "sch.vectorize(loop=l86)",
            'sch.annotate(block_or_loop=l85, ann_key="meta_schedule.lazy_cooperative_fetch", ann_val=1)',
            'b87 = sch.cache_read(block=b1, read_buffer_index=2, storage_scope="shared")',
            "sch.compute_at(block=b87, loop=l65, preserve_unit_loops=1)",
            "l88, l89, l90, l91, l92, l93, l94, l95, l96, l97 = sch.get_loops(block=b87)",
            "l98 = sch.fuse(l94, l95, l96, l97)",
            "v99, v100 = sch.sample_perfect_tile(loop=l98, n=2, max_innermost_factor=4)",
            "l101, l102 = sch.split(loop=l98, factors=[v99, v100])",
            "sch.vectorize(loop=l102)",
            'sch.annotate(block_or_loop=l101, ann_key="meta_schedule.lazy_cooperative_fetch", ann_val=1)',
...
def test_meta_schedule_cuda_sketch_conv2d_nchw_bias_bn_relu():  # pylint: disable=invalid-name
    ...
    expected = [
        [
            ...
            "l89, l90 = sch.split(loop=l86, factors=[v87, v88])",
            "sch.vectorize(loop=l90)",
            'sch.annotate(block_or_loop=l89, ann_key="meta_schedule.lazy_cooperative_fetch", ann_val=1)',
            'b91 = sch.cache_read(block=b1, read_buffer_index=2, storage_scope="shared")',
            "sch.compute_at(block=b91, loop=l69, preserve_unit_loops=1)",
            "l92, l93, l94, l95, l96, l97, l98, l99, l100, l101 = sch.get_loops(block=b91)",
            "l102 = sch.fuse(l98, l99, l100, l101)",
            "v103, v104 = sch.sample_perfect_tile(loop=l102, n=2, max_innermost_factor=4)",
            "l105, l106 = sch.split(loop=l102, factors=[v103, v104])",
            "sch.vectorize(loop=l106)",
            'sch.annotate(block_or_loop=l105, ann_key="meta_schedule.lazy_cooperative_fetch", ann_val=1)',
