...
def test_meta_schedule_cuda_sketch_matmul_relu():
    ...
    expected = [
        [
            ...
            "sch.compute_at(block=b36, loop=l30, preserve_unit_loops=1)",
            ...
            "sch.compute_at(block=b46, loop=l30, preserve_unit_loops=1)",
            ...
            "sch.reverse_compute_at(block=b3, loop=l35, preserve_unit_loops=1)",
...
def test_meta_schedule_cuda_sketch_conv2d_nchw():
    ...
    expected = [
        [
            ...
            "sch.compute_at(block=b72, loop=l66, preserve_unit_loops=1)",
            ...
            "sch.compute_at(block=b86, loop=l66, preserve_unit_loops=1)",
            ...
            "sch.reverse_compute_at(block=b3, loop=l71, preserve_unit_loops=1)",
...
def test_meta_schedule_cuda_sketch_conv2d_nchw_bias_bn_relu():  # pylint: disable=invalid-name
    ...
    expected = [
        [
            ...
            "sch.compute_at(block=b76, loop=l70, preserve_unit_loops=1)",
            ...
            "sch.compute_at(block=b90, loop=l70, preserve_unit_loops=1)",
            ...
            "sch.reverse_compute_at(block=b7, loop=l75, preserve_unit_loops=1)",
