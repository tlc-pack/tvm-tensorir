...
class Module:
    def default_function(args: ty.handle, arg_type_ids: ty.handle, num_args: ty.int32, out_ret_value: ty.handle, out_ret_tcode: ty.handle) -> ty.int32:
        # function attr dict
        # tir.set_func_attr("target", meta[Target][0])
        tir.set_func_attr("tir.is_entry_func", tir.bool(1))
        tir.set_func_attr("global_symbol", "default_function")
        tir.set_func_attr("calling_conv", 1)
        # var definition
        # body
        tir.Assert((num_args == 3), "default_function: num_args should be 3")
        arg0: ty.handle = tir.tvm_struct_get(args, 0, 12, dtype="handle")
        arg0_code: ty.int32 = tir.load("int32", arg_type_ids, 0, tir.bool(1))
        arg1: ty.handle = tir.tvm_struct_get(args, 1, 12, dtype="handle")
        arg1_code: ty.int32 = tir.load("int32", arg_type_ids, 1, tir.bool(1))
        arg2: ty.handle = tir.tvm_struct_get(args, 2, 12, dtype="handle")
        arg2_code: ty.int32 = tir.load("int32", arg_type_ids, 2, tir.bool(1))
        A_1: ty.handle = tir.tvm_struct_get(arg0, 0, 1, dtype="handle")
        tir.attr(A_1, "storage_alignment", 128)
        ...
        B_1: ty.handle = tir.tvm_struct_get(arg1, 0, 1, dtype="handle")
        tir.attr(B_1, "storage_alignment", 128)
        ...
        C_1: ty.handle = tir.tvm_struct_get(arg2, 0, 1, dtype="handle")
        tir.attr(C_1, "storage_alignment", 128)
        ...
        tir.Assert((1024 == tir.cast("int32", tir.load("int64", arg0_shape, 0, tir.bool(1)))), "Argument arg0.shape[0] has an unsatisfied constraint")
        with tir.Assert((1024 == tir.cast("int32", tir.load("int64", arg0_shape, 1, tir.bool(1)))), "Argument arg0.shape[1] has an unsatisfied constraint"):
            if not (tir.isnullptr(arg0_strides, dtype="bool")):
                tir.Assert(((1 == tir.cast("int32", tir.load("int64", arg0_strides, 1, tir.bool(1)))) and (1024 == tir.cast("int32", tir.load("int64", arg0_strides, 0, tir.bool(1))))), "arg0.strides: expected to be compact array")
                tir.evaluate(0)
            ...
            tir.Assert((1024 == tir.cast("int32", tir.load("int64", arg1_shape, 0, tir.bool(1)))), "Argument arg1.shape[0] has an unsatisfied constraint")
            with tir.Assert((1024 == tir.cast("int32", tir.load("int64", arg1_shape, 1, tir.bool(1)))), "Argument arg1.shape[1] has an unsatisfied constraint"):
                if not (tir.isnullptr(arg1_strides, dtype="bool")):
                    tir.Assert(((1 == tir.cast("int32", tir.load("int64", arg1_strides, 1, tir.bool(1)))) and (1024 == tir.cast("int32", tir.load("int64", arg1_strides, 0, tir.bool(1))))), "arg1.strides: expected to be compact array")
                    tir.evaluate(0)
                ...
                tir.Assert((1024 == tir.cast("int32", tir.load("int64", arg2_shape, 0, tir.bool(1)))), "Argument arg2.shape[0] has an unsatisfied constraint")
                with tir.Assert((1024 == tir.cast("int32", tir.load("int64", arg2_shape, 1, tir.bool(1)))), "Argument arg2.shape[1] has an unsatisfied constraint"):
                    if not (tir.isnullptr(arg2_strides, dtype="bool")):
                        tir.Assert(((1 == tir.cast("int32", tir.load("int64", arg2_strides, 1, tir.bool(1)))) and (1024 == tir.cast("int32", tir.load("int64", arg2_strides, 0, tir.bool(1))))), "arg2.strides: expected to be compact array")
                        tir.evaluate(0)
                        ...
                        for j_outer_init in tir.range(0, 32):
                            for i_inner_init in tir.range(0, 32):
                                for j_inner_init in tir.range(0, 32):
                                    tir.store(C_1, ((((i_outer*32768) + (i_inner_init*1024)) + (j_outer_init*32)) + j_inner_init), tir.float32(0), tir.bool(1))
                                ...
                                for k_inner in tir.range(0, 4):
                                    for i_inner in tir.range(0, 32):
                                        for j_inner in tir.range(0, 32):
                                            tir.store(C_1, ((((i_outer*32768) + (i_inner*1024)) + (j_outer*32)) + j_inner), tir.call_llvm_pure_intrin(tir.uint32(97), tir.uint32(3), tir.load("float32", A_1, ((((i_outer*32768) + (i_inner*1024)) + (k_outer*4)) + k_inner), tir.bool(1)), tir.load("float32", B_1, ((((k_outer*4096) + (k_inner*1024)) + (j_outer*32)) + j_inner), tir.bool(1)), tir.load("float32", C_1, ((((i_outer*32768) + (i_inner*1024)) + (j_outer*32)) + j_inner), tir.bool(1)), dtype="float32"), tir.bool(1))
    __tvm_meta__ = {
        "root": 1,
        "nodes": [
            {
...
class Module2:
    def default_function(A: ty.handle, W: ty.handle, Conv: ty.handle) -> None:
        # function attr dict
        tir.set_func_attr("global_symbol", "default_function")
        tir.set_func_attr("tir.noalias", tir.bool(1))
        # var definition
        A_2 = tir.var("handle")
        Apad_shared_1 = tir.var("handle")
        Apad_shared_wmma_matrix_a_1 = tir.var("handle")
        BA_1 = tir.var("handle")
        BA_elem_offset = tir.var("int32")
        BB_1 = tir.var("handle")
        BB_elem_offset = tir.var("int32")
        BC_1 = tir.var("handle")
        BC_elem_offset = tir.var("int32")
        Conv_2 = tir.var("handle")
        Conv_wmma_accumulator_1 = tir.var("handle")
        W_2 = tir.var("handle")
        W_shared_1 = tir.var("handle")
        W_shared_wmma_matrix_b_1 = tir.var("handle")
        blockIdx_x = tir.var("int32")
        blockIdx_y = tir.var("int32")
        blockIdx_z = tir.var("int32")
        buffer_10 = tir.var("handle")
        buffer_11 = tir.var("handle")
        buffer_2 = tir.var("handle")
        buffer_3 = tir.var("handle")
        buffer_6 = tir.var("handle")
        buffer_7 = tir.var("handle")
        buffer_elem_offset = tir.var("int32")
        buffer_elem_offset_1 = tir.var("int32")
        buffer_elem_offset_2 = tir.var("int32")
        buffer_elem_offset_3 = tir.var("int32")
        buffer_elem_offset_4 = tir.var("int32")
        buffer_elem_offset_5 = tir.var("int32")
        threadIdx_x = tir.var("int32")
        threadIdx_y = tir.var("int32")
        threadIdx_z = tir.var("int32")
        # buffer definition
        Apad_shared = tir.buffer_decl(Apad_shared_1, [16, 16, 16, 16, 16, 16], "float16")
        Apad_shared_wmma_matrix_a = tir.buffer_decl(Apad_shared_wmma_matrix_a_1, [16, 16, 16, 16, 16, 16], "float16")
        BA = tir.buffer_decl(BA_1, [16, 16], "float16", elem_offset=BA_elem_offset, scope="wmma.matrix_a", align=32, offset_factor=256)
        BB = tir.buffer_decl(BB_1, [16, 16], "float16", elem_offset=BB_elem_offset, scope="wmma.matrix_b", align=32, offset_factor=256)
        BC = tir.buffer_decl(BC_1, [16, 16], elem_offset=BC_elem_offset, scope="wmma.accumulator", align=32, offset_factor=256)
        Conv_wmma_accumulator = tir.buffer_decl(Conv_wmma_accumulator_1, [16, 14, 14, 32, 16, 16])
        W_shared = tir.buffer_decl(W_shared_1, [3, 3, 16, 32, 16, 16], "float16")
        W_shared_wmma_matrix_b = tir.buffer_decl(W_shared_wmma_matrix_b_1, [3, 3, 16, 32, 16, 16], "float16")
        buffer = tir.buffer_decl(buffer_3, [16, 16], "float16", elem_offset=buffer_elem_offset_1, scope="shared", align=32, offset_factor=256)
        buffer_1 = tir.buffer_decl(buffer_2, [16, 16], "float16", elem_offset=buffer_elem_offset, scope="wmma.matrix_a", align=32, offset_factor=256)
        buffer_4 = tir.buffer_decl(buffer_7, [16, 16], "float16", elem_offset=buffer_elem_offset_3, scope="shared", align=32, offset_factor=256)
        buffer_5 = tir.buffer_decl(buffer_6, [16, 16], "float16", elem_offset=buffer_elem_offset_2, scope="wmma.matrix_b", align=32, offset_factor=256)
        buffer_8 = tir.buffer_decl(buffer_10, [16, 16], elem_offset=buffer_elem_offset_4, scope="wmma.accumulator", align=32, offset_factor=256)
        buffer_9 = tir.buffer_decl(buffer_11, [16, 16], elem_offset=buffer_elem_offset_5, align=32, offset_factor=256)
        A_1 = tir.buffer_bind(A, A_2, [16, 14, 14, 16, 16, 16], "float16")
        W_1 = tir.buffer_bind(W, W_2, [3, 3, 16, 32, 16, 16], "float16")
        Conv_1 = tir.buffer_bind(Conv, Conv_2, [16, 14, 14, 32, 16, 16])
        # body
        tir.attr(Conv_1, "realize_scope", "")
        tir.realize(Conv_1[0:16, 0:14, 0:14, 0:32, 0:16, 0:16], tir.bool(1))
        ...
        with tir.realize(Conv_wmma_accumulator[((blockIdx_x*8) + (threadIdx_y*2)):(((blockIdx_x*8) + (threadIdx_y*2)) + 2), tir.floordiv(blockIdx_z, 14):(tir.floordiv(blockIdx_z, 14) + 1), tir.floormod(blockIdx_z, 14):(tir.floormod(blockIdx_z, 14) + 1), ((blockIdx_y*8) + (threadIdx_z*4)):(((blockIdx_y*8) + (threadIdx_z*4)) + 4), 0:16, 0:16], tir.bool(1)):
            for n_c_init in tir.range(0, 2):
                for o_c_init in tir.range(0, 4):
                    ...
                    tir.evaluate(tir.tvm_fill_fragment(BC_1, 16, 16, 16, tir.floordiv(BC_elem_offset, 256), tir.float32(0), dtype="handle"))
            for ic_outer in tir.range(0, 8):
                for kh in tir.range(0, 3):
                    tir.attr(Apad_shared, "realize_scope", "shared")
                    with tir.realize(Apad_shared[(blockIdx_x*8):((blockIdx_x*8) + 8), (tir.floordiv(blockIdx_z, 14) + kh):((tir.floordiv(blockIdx_z, 14) + kh) + 1), tir.floormod(blockIdx_z, 14):(tir.floormod(blockIdx_z, 14) + 3), (ic_outer*2):((ic_outer*2) + 2), 0:16, 0:16], tir.bool(1)):
                        ...
                        with tir.realize(W_shared[kh:(kh + 1), 0:3, (ic_outer*2):((ic_outer*2) + 2), (blockIdx_y*8):((blockIdx_y*8) + 8), 0:16, 0:16], tir.bool(1)):
                            ...
                            for ic_inner in tir.range(0, 2):
                                for kw in tir.range(0, 3):
                                    ...
                                    with tir.realize(Apad_shared_wmma_matrix_a[((blockIdx_x*8) + (threadIdx_y*2)):(((blockIdx_x*8) + (threadIdx_y*2)) + 2), (tir.floordiv(blockIdx_z, 14) + kh):((tir.floordiv(blockIdx_z, 14) + kh) + 1), (kw + tir.floormod(blockIdx_z, 14)):((kw + tir.floormod(blockIdx_z, 14)) + 1), ((ic_outer*2) + ic_inner):(((ic_outer*2) + ic_inner) + 1), 0:16, 0:16], tir.bool(1)):
                                        for ax0 in tir.range(0, 2):
                                            ...
                                            tir.evaluate(tir.tvm_load_matrix_sync(buffer_2, 16, 16, 16, tir.floordiv(buffer_elem_offset, 256), tir.tvm_access_ptr(tir.type_annotation(dtype="float16"), buffer_3, buffer_elem_offset_1, 256, 1, dtype="handle"), 16, "row_major", dtype="handle"))
                                        tir.attr(W_shared_wmma_matrix_b, "realize_scope", "wmma.matrix_b")
                                        with tir.realize(W_shared_wmma_matrix_b[kh:(kh + 1), kw:(kw + 1), ((ic_outer*2) + ic_inner):(((ic_outer*2) + ic_inner) + 1), ((blockIdx_y*8) + (threadIdx_z*4)):(((blockIdx_y*8) + (threadIdx_z*4)) + 4), 0:16, 0:16], tir.bool(1)):
                                            for ax3_1 in tir.range(0, 4):
                                                tir.attr([buffer_4, W_shared], "buffer_bind_scope", tir.tvm_tuple(kh, 1, kw, 1, ((ic_outer*2) + ic_inner), 1, (ax3_1 + ((blockIdx_y*8) + (threadIdx_z*4))), 1, 0, 16, 0, 16, dtype="handle"))
                                                tir.attr([buffer_5, W_shared_wmma_matrix_b], "buffer_bind_scope", tir.tvm_tuple(kh, 1, kw, 1, ((ic_outer*2) + ic_inner), 1, (ax3_1 + ((blockIdx_y*8) + (threadIdx_z*4))), 1, 0, 16, 0, 16, dtype="handle"))
                                                tir.evaluate(tir.tvm_load_matrix_sync(buffer_6, 16, 16, 16, tir.floordiv(buffer_elem_offset_2, 256), tir.tvm_access_ptr(tir.type_annotation(dtype="float16"), buffer_7, buffer_elem_offset_3, 256, 1, dtype="handle"), 16, "row_major", dtype="handle"))
                                            for n_c in tir.range(0, 2):
                                                for o_c in tir.range(0, 4):
                                                    ...
                                                    tir.evaluate(tir.tvm_mma_sync(BC_1, tir.floordiv(BC_elem_offset, 256), BA_1, tir.floordiv(BA_elem_offset, 256), BB_1, tir.floordiv(BB_elem_offset, 256), BC_1, tir.floordiv(BC_elem_offset, 256), dtype="handle"))
            for n_inner in tir.range(0, 2):
                for o_inner in tir.range(0, 4):
                    tir.attr([buffer_8, Conv_wmma_accumulator], "buffer_bind_scope", tir.tvm_tuple(((((blockIdx_x*4) + threadIdx_y)*2) + n_inner), 1, tir.floordiv(blockIdx_z, 14), 1, tir.floormod(blockIdx_z, 14), 1, ((((blockIdx_y*2) + threadIdx_z)*4) + o_inner), 1, 0, 16, 0, 16, dtype="handle"))
                    tir.attr([buffer_9, Conv_1], "buffer_bind_scope", tir.tvm_tuple(((((blockIdx_x*4) + threadIdx_y)*2) + n_inner), 1, tir.floordiv(blockIdx_z, 14), 1, tir.floormod(blockIdx_z, 14), 1, ((((blockIdx_y*2) + threadIdx_z)*4) + o_inner), 1, 0, 16, 0, 16, dtype="handle"))
                    tir.evaluate(tir.tvm_store_matrix_sync(buffer_10, 16, 16, 16, tir.floordiv(buffer_elem_offset_4, 256), tir.tvm_access_ptr(tir.type_annotation(dtype="float32"), buffer_11, buffer_elem_offset_5, 256, 2, dtype="handle"), 16, "row_major", dtype="handle"))
