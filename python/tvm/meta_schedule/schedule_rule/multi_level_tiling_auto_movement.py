...
@register_object("meta_schedule.MultiLevelTilingAutoMovement")
class MultiLevelTilingAutoMovement(ScheduleRule):
    """Multi-level tiling with reuse.
    ...
    compute_intrin : Optional[str]
        The intrin to tensorize
    """
    ...
    def __init__(
            ...
            compute_intrin: Optional[str] = None
    ) -> None:
        self.__init_handle_by_constructor__(
            _ffi_api.ScheduleRuleMultiLevelTilingAutoMovement,  # type: ignore # pylint: disable=no-member
            structure,
            tile_binds,
