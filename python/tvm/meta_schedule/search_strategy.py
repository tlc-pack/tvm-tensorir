...
class SearchStrategy(Object):
    ...
    When the `notify_measure_results` method is called, the search strategy will notify the
    measure results. The measure results are used to update the search strategy.
    """
    ...
    def initialize_with_tune_context(
        ...
        """
        _ffi_api.SearchStrategyInitializeWithTuneContext(context)  # pylint: disable=no-member
    ...
    def notify_measure_results(self, results: List["MeasureResult"]) -> None:
        """Notify the measure results.

        Parameters
        ----------
        results : List[MeasureResult]
            The measure results generated by the runner, to be used to update the search strategy.
        """
        _ffi_api.SearchStrategyNotifyMeasureResults(results)  # pylint: disable=no-member
    ...
    def pre_tuning(self, design_spaces: List[Trace]) -> None:
        ...
        """
        _ffi_api.SearchStrategyPreTuning(design_spaces)  # pylint: disable=no-member

    def post_tuning(self) -> None:
        """Finish the search strategy process after tuning"""
        _ffi_api.SearchStrategyPostTuning()  # pylint: disable=no-member
...
class PySearchStrategy(SearchStrategy):
    ...
    def __init__(self):
        ...
        def notify_measure_results_func(results: List["MeasureResult"]) -> None:
            """Pass the notify_measure_results function to constructor."""
