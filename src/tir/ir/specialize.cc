...
class BufferMutator : public StmtExprMutator {
 public:
  ...
  Stmt VisitStmt_(const BlockNode* op) override {
    ...
    Array<Buffer> allocations = MutateArray(op->alloc_buffers, fmutate_buffer_allocate);
