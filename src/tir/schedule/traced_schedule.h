...
class TracedScheduleNode : public ConcreteScheduleNode {
 ...
 public:
  ...
  BlockRV CacheRead(const BlockRV& block_rv, int buffer_index, const String& storage_scope) final;
  BlockRV CacheWrite(const BlockRV& block_rv, int buffer_index, const String& storage_scope) final;
