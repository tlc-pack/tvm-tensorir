...
class ConcreteScheduleNode : public ScheduleNode {
 ...
 public:
  ...
  BlockRV CacheRead(const BlockRV& block_rv, int buffer_index, const String& storage_scope) override;
  BlockRV CacheWrite(const BlockRV& block_rv, int buffer_index, const String& storage_scope) override;
