...
Array<Array<ExprRV>> ConcreteScheduleNode::SampleShapeGenericTiles(
    const Array<LoopRV>& loop_rvs, const std::vector<int>& ns,
    const Target& target, int max_innermost_factor, Optional<Array<Array<Integer>>> decision) {
  TVM_TIR_SCHEDULE_BEGIN();
