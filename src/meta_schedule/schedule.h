...
#include "../tir/schedule/traced_schedule.h"
...
//    */
//   Array<tir::ExprRV> SamplePerfectTile(const LoopRV& loop_rv,     //
//                                        int n,                     //
...
//    */
//   tir::ExprRV SampleCategorical(const Array<Integer>& candidates,  //
...
//    */
//   LoopRV SampleComputeLocation(const BlockRV& block_rv, Optional<Integer> decision = NullOpt)
//   final;
...
//    * \param factor_axis The position where the new dimension is placed in the new generated
//    rfactor
//    *                    buffer
