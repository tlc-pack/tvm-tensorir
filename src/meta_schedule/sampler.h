...
class RandEngine {
 public:
  ...
  static constexpr int64_t multiplier = 48271;
  /*! \brief An increment */
  static constexpr int64_t increment = 0;
  /*! \brief The modulus */
  static constexpr int64_t modulus = 2147483647;
  ...
  int64_t min() { return 0; }

  int64_t max() { return modulus - 1; }

  int64_t random_state() { return *rand_state_ptr; }

  int64_t operator()() { return next_state(); }
...
class Sampler {
 public:
   ...
   */
  explicit Sampler(int64_t* random_state) : rand_(random_state) {}
