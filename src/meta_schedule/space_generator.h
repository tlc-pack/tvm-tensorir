...
class SpaceGeneratorNode : public runtime::Object {
 public:
  ...
  /*! \brief Initialize the design space with TuneContext */
  virtual void InitializeWithTuneContext(const TuneContext& context) = 0;

  /*!
   * \brief Sample a schedule out of the design space
   * \return The schedule sampled
   */
  // todo @ zxybazh: Change to Traces class
  virtual runtime::Array<runtime::ObjectRef> Generate() = 0;
...
class SpaceGenerator : public runtime::ObjectRef {
 public:
  ...
  static SpaceGenerator PySpaceGenerator(runtime::PackedFunc init_with_tune_context_func,
