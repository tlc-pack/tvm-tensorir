...
//   explicit APICall(const String& method_name) : method_name(method_name), output(NullOpt) {}
...
//                                       const Optional<ObjectRef>& decision) const {
//   APICall py("sample_perfect_tile");
...
//                                           const Array<String>& outputs,
//                                           const Optional<ObjectRef>& decision) const {
//   APICall py("sample_compute_location");
...
//                           const Array<String>& outputs, const Optional<ObjectRef>& decision)
//                           const {
//   APICall py("split");
//   py.AddArgInput("loop", inputs[0]);
...
//                                          const Array<String>& outputs,
//                                          const Optional<ObjectRef>& decision) const {
//   APICall py("reverse_compute_inline");
//   py.AddArgInput("block", inputs[0]);
//   py.Print(os);
// }
...
//                                        const Array<String>& outputs,
//                                        const Optional<ObjectRef>& decision) const {
//   APICall py("decompose_reduction");
//   py.AddArgInput("block", inputs[0]);
//   py.AddArgInput("loop", inputs[1]);
//   py.AddOutput(outputs[0]);
//   py.Print(os);
...
// void GetBlockAttrs::Serialize(Array<ObjectRef>* record, const Optional<ObjectRef>& decision)
// const {
//   ICHECK(!decision.defined());
...
// void MarkLoopAttrs::Serialize(Array<ObjectRef>* record, const Optional<ObjectRef>& decision)
// const {
//   ICHECK(!decision.defined());
...
// void BlockizeAttrs::Serialize(Array<ObjectRef>* record, const Optional<ObjectRef>& decision)
// const {
//   ICHECK(!decision.defined());
// }
...
// void SetScopeAttrs::Serialize(Array<ObjectRef>* record, const Optional<ObjectRef>& decision)
// const {
//   ICHECK(!decision.defined());
//   record->push_back(Integer(i));
//   record->push_back(this->storage_scope);
...
// InstAttrs RFactorAttrs::Deserialize(const Array<ObjectRef>& record, Optional<ObjectRef>*
// decision) {
//   ObjectPtr<RFactorAttrs> n = make_object<RFactorAttrs>();
