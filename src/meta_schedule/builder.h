...
class BuilderNode : public runtime::Object {
 public:
  ...
  virtual Array<BuildResult> Build(Array<BuildInput> build_inputs) = 0;

  using FBuild = runtime::TypedPackedFunc<Array<BuildResult>(Array<BuildInput>)>;
...
class PyBuilderNode : public BuilderNode {
 public:
  ...
  Array<BuildResult> Build(Array<BuildInput> build_inputs) final { return f_build(build_inputs); }
